...
//					В отдельных участках кода (Случай 1,2,3) реализовано создание двухмерных массивов различными способами.
//					Замер времени выполнения реалисован в классе TimeElapsed.
